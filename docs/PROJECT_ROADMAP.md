...
| 8 | Final Polish + Handover | **DONE (partea fără domeniu) — 2026-09-21**: `docs/MAINTENANCE.md`, docs aliniate la implementare, verificare completă pe build (format/tipuri/16 unit/46 e2e/fidelitate/audit). **Rămâne după activarea domeniului:** checklist-ul din `MAINTENANCE.md` §7 (verificări pe domeniu, Resend Verify, Search Console, export DNS, HSTS întărit, anulare Wix Premium) | — |
